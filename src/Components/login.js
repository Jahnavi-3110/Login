    ...
    <>
      ...
      <div className="body">
        <div className="main-form1">
          <div className="title">
            <div className="head">Join Organization</div>
            {/* <button
              className="canclebtn"
          ...
          <div className="logbtns facebookbtn ">
            <button>
              <svg
                width="20"
                height="20"
          ...
          <div className="logbtns googlebtn">
            <button>
              <svg
                width="18"
                height="19"
          ...
          <div className="logbtns applebtn">
            <button>
              <svg
                width="16"
                height="18"
            ...
            <form action="#">
              <div className="user-det1">
                ...
                <div className="agreement">
                  <span>By joining I agree to receive emails from the Organization.</span>
                </div>
              </div>
              <hr />
              <div className="ask">
